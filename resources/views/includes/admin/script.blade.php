<!-- All Jquery -->
    ...
    <script src="{{url('backend/dist/js/feather.min.js')}}"></script>
    ...
    <script src="{{url('backend/assets/extra-libs/c3/d3.min.js')}}"></script>
    <script src="{{url('backend/assets/extra-libs/c3/c3.min.js')}}"></script>
    ...
    <script src="{{url('backend/assets/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js')}}"></script>
    <script src="{{url('backend/assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js')}}"></script>
    <script src="{{url('backend/dist/js/pages/dashboards/dashboard1.min.js')}}"></script>
